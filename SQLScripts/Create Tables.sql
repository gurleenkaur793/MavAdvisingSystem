...
INSERT INTO user (email, username, password_hash, password_salt, password_expiration, firstname, lastname, uta_id, user_type) VALUES
	('admin@mavs.uta.edu', 'admin', 'h8pZ8TVpdqY3muqGXTjRCyIiROWNiphv4lKKuxHwXJY=', 'Sdhz6ypNg1cKf0cBVsjNZg==', '2016-01-01', 'System', 'Admin', '1001999999', 1),
    ('advisor@mavs.uta.edu', 'advisor', 'RT7alRXi1mc2TC0/iLyl22i+herJDKunD/zVsv3E8DY=', 'eK0PkdrGz4SFB6UrMybw7Q==', '2016-01-01', 'Bob', 'Advisor', '1001001234', 2),
    ('student@mavs.uta.edu', 'student', 'NlSnpZZR5EKmVXYJMzL+pdGwSsmv5+czi3GXecUMOvA=', 'R+Z/6aNNRWjxD27lBQ2sMg==', '2016-01-01', 'Joe', 'Student', '1001123456', 3);
