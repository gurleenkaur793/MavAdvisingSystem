		...
		<div class="col-xs-12 col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-xs-6 col-md-4">Name: ${user.getLastName()},
						${user.getFirstName()}</div>
					<div class="col-xs-6 col-md-4">UTA ID: ${user.getUtaId()}</div>
					<div class="col-xs-6 col-md-4">Email: ${user.getEmail()}</div>
					<div class="col-xs-6 col-md-4">Type:
						${user.getStudentType().description()}</div>
					<div class="col-xs-6 col-md-4">Status:
						${user.getEnrollmentStatus().description()}</div>
				</div>
			</div>
		</div>
	</div>
					...
					<tbody>
						<c:forEach items="${appointments}" var="entry">
							<tr>
								...
								<td>${entry.getAdvisor().getLastName()},
									${entry.getAdvisor().getFirstName()}</td>
