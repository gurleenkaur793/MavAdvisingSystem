		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form name="appointment_show" id="appointment_show"
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Go
						Back</button>
					<button type="button" name="confirm_cancel_btn"
						id="confirm_cancel_btn" class="btn btn-warning">Cancel
						Appointment</button>
				</div>
			</div>
		</div>
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<form name="appointment_show" id="appointment_show"
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<p class="form-control-static">${appt.getAdvisor().getFirstName()}
										${appt.getAdvisor().getLastName()}</p>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<p class="form-control-static">${appt.getStudent().getFirstName()}
										${appt.getStudent().getLastName()}</p>
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-3 control-label" for="Advsing Task">Advising
									Task</label>
								<div class="col-sm-9">
					...
					<div class="panel-footer">
						<button type="button" class="btn btn-info" name="edit_btn"
							id="edit_btn">Edit</button>
						<button type="button" class="btn btn-danger" name="cancel_btn"
