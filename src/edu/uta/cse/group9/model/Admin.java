...
public class Admin extends User {
	...
	public Admin(Integer id, String email, String username, String passwordHash, String passwordSalt,
			Date passwordExpiration, String firstName, String lastName, String utaId) {
		super(id, email, username, passwordHash, passwordSalt, passwordExpiration, firstName, lastName, utaId);
	}
