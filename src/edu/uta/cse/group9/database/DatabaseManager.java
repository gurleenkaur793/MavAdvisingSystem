...
public class DatabaseManager {
	...
	public boolean assignStudent(int advisorId, int no_of_students, String startStudent, String endStudent) throws Exception {
		return imp.assignStudent(advisorId, no_of_students, startStudent, endStudent); }
